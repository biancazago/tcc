...
const routes: Routes = [
  ...
  { path: RouteNames.PROVA, loadChildren: () => import('./modules/prova/prova.module').then(m => m.ProvaModule) },
  { path: RouteNames.PERGUNTA, loadChildren: () => import('./modules/pergunta/pergunta.module').then(m => m.PerguntaModule) },
  { path: RouteNames.PROFESSOR, loadChildren: () => import('./modules/professor/professor.module').then(m => m.ProfessorModule) },
  // { path: RouteNames.AREA, loadChildren: () => import('./modules/area/area.module').then(m => m.AreaModule) },
  { path: RouteNames.ALUNO, loadChildren: () => import('./modules/aluno/aluno.module').then(m => m.AlunoModule) },
